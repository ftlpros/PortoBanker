 ...
 * @author eipps
 */
public class POIDetailsUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pOIDetailsPanel1 = new com.porto.ui.telecom.POIDetailsPanel();
        ...
        jScrollPane1.setViewportView(pOIDetailsPanel1);
    ...
    private void buttonActionHandler(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonActionHandler
       String command = evt.getActionCommand();
        if(command.equals("NEXT")) {
            PortoMain.getInstance().setContentPanel(new POADetailsUI());
        }
    ...
    private com.porto.ui.telecom.POIDetailsPanel pOIDetailsPanel1;
